...
export default function Home() {
    ...
    return (
        ...
        >
            ...
            {chat.length == 0 && <StartChat generateResponse={generateResponse} />}
            ...
            <InputChat generateResponse={generateResponse} setScroll={setScrollToBottom} chat={chat} clearChat={() => setChat([])} />
